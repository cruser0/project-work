namespace WinformDotNetFramework.Forms.AddForms
{
    partial class CreateSupplierForm
    {
        ...
        {
            this.CreateSupplierUserControl = new WinformDotNetFramework.Forms.control.CreateCustomerSupplierUserControl();
            this.SuspendLayout();
            // 
        ...
        private control.CreateCustomerSupplierUserControl CreateSupplierUserControl;
    }
}