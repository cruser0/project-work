...
namespace WinformDotNetFramework.Forms.FinalForms
{
    public partial class CustomerFinalForm : Form
    {
        ...
        private async void SearchBtn_Click(object sender, EventArgs e)
        {
            ...
            switch (searchCustomer1.comboBox1.SelectedIndex)
            {
                case 1:
            ...
            if (searchCustomer1.DateFromClnd.Checked)
            {
                customerfilter.CustomerCreatedDateFrom = searchCustomer1.DateFromClnd.Value;
            }
            else
            {
            ...
            if (searchCustomer1.DateToClnd.Checked)
            {
                customerfilter.CustomerCreatedDateTo = searchCustomer1.DateToClnd.Value;
            }
            else
            {
            ...
            if (string.IsNullOrEmpty(searchSale1.RevenueFromTxt.GetText()))
            {
                saleFilter.SaleRevenueFrom = null;
            }
            else
            {
                saleFilter.SaleRevenueFrom = int.Parse(searchSale1.RevenueFromTxt.GetText());
            }

            if (string.IsNullOrEmpty(searchSale1.RevenueToTxt.GetText()))
            {
                saleFilter.SaleRevenueTo = null;
            }
            else
            {
                saleFilter.SaleRevenueTo = int.Parse(searchSale1.RevenueToTxt.GetText());
            }

            saleFilter.SaleCustomerId = null;

            if (searchSale1.StatusCB.Text == "All")
            {
                saleFilter.SaleStatus = null;
            }
            else
            {
                saleFilter.SaleStatus = searchSale1.StatusCB.Text;
            }

            if (searchCustomer1.DateFromClnd.Checked)
            {
                saleFilter.SaleDateFrom = searchSale1.DateFromDTP.Value;
            }
            else
            {
            ...
            if (searchCustomer1.DateToClnd.Checked)
            {
                saleFilter.SaleDateTo = searchSale1.DateToDTP.Value;
            }
            else
            {
            ...
            if (searchCustomerInvoice1.DateFromClnd.Checked)
            {
                customerInvoiceFilter.CustomerInvoiceInvoiceDateFrom = searchCustomerInvoice1.DateFromClnd.Value;
            }
            else
            {
            ...
            if (searchCustomerInvoice1.DateToClnd.Checked)
            {
                customerInvoiceFilter.CustomerInvoiceInvoiceDateTo = searchCustomerInvoice1.DateToClnd.Value;
            }
            else
            {
            ...
            customerInvoiceFilter.CustomerInvoiceStatus = searchCustomerInvoice1.StatusCmb.Text;

            if (string.IsNullOrEmpty(searchCustomerInvoice1.AmountFromTxt.GetText()))
            {
                customerInvoiceFilter.CustomerInvoiceInvoiceAmountFrom = null;
            }
            else
            {
                customerInvoiceFilter.CustomerInvoiceInvoiceAmountFrom = int.Parse(searchCustomerInvoice1.AmountFromTxt.GetText());
            }

            if (string.IsNullOrEmpty(searchCustomerInvoice1.AmountToTxt.GetText()))
            {
                customerInvoiceFilter.CustomerInvoiceInvoiceAmountTo = null;
            }
            else
            {
                customerInvoiceFilter.CustomerInvoiceInvoiceAmountTo = int.Parse(searchCustomerInvoice1.AmountToTxt.GetText());
            }
            ...
            if (string.IsNullOrEmpty(searchCustomerInvoiceCost1.CostFromTxt.GetText()))
            {
                customerInvoiceCostfilter.CustomerInvoiceCostCostFrom = null;
            }
            else
            {
                customerInvoiceCostfilter.CustomerInvoiceCostCostFrom = int.Parse(searchCustomerInvoiceCost1.CostFromTxt.GetText());
            }

            if (string.IsNullOrEmpty(searchCustomerInvoiceCost1.CostToTxt.GetText()))
            {
                customerInvoiceCostfilter.CustomerInvoiceCostCostTo = null;
            }
            else
            {
                customerInvoiceCostfilter.CustomerInvoiceCostCostTo = int.Parse(searchCustomerInvoiceCost1.CostToTxt.GetText());
            }
