...
namespace API.Migrations
{
    ...
    [Migration("20250408151426_CustomerUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.CustomerInvoiceAmountPaid", b =>
                {
                    b.Property<int>("CustomerInvoiceAmountPaidID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CustomerInvoiceAmountPaidID"), 1L, 1);
                    ...
                    b.HasKey("CustomerInvoiceAmountPaidID");

                    b.HasIndex("CustomerInvoiceID")
                        .IsUnique()
                        .HasFilter("[CustomerInvoiceID] IS NOT NULL");

                    b.ToTable("CustomerInvoiceAmoutPaids", (string)null);
                });
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.CustomerUser", b =>
                {
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TokenID = 1,
                            Created = new DateTime(2025, 4, 8, 17, 14, 24, 317, DateTimeKind.Local).AddTicks(95),
                            Expires = new DateTime(2025, 4, 18, 17, 14, 24, 317, DateTimeKind.Local).AddTicks(153),
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.SupplierInvoiceCost", b =>
                {
                    ...
                    b.Property<int?>("CustomerInvoiceCostID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomerInvoiceCostID");
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.CustomerInvoiceAmountPaid", b =>
                {
                    b.HasOne("Entity_Validator.Entity.Entities.CustomerInvoice", "CustomerInvoice")
                        .WithOne("CustomerInvoiceAmountPaid")
                        .HasForeignKey("Entity_Validator.Entity.Entities.CustomerInvoiceAmountPaid", "CustomerInvoiceID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("FK_CustomerInvoice_CustomerInvoicePaidAmount");
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.RefreshToken", b =>
                {
                    b.HasOne("Entity_Validator.Entity.Entities.CustomerUser", "CustomerUser")
                        .WithMany("RefreshTokens")
                        .HasForeignKey("CustomerUserID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("FK_RefreshTokens_CustomerUsers");
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.SupplierInvoiceCost", b =>
                {
                    ...
                    b.HasOne("Entity_Validator.Entity.Entities.CustomerInvoiceCost", "CustomerInvoiceCost")
                        .WithMany("SupplierInvoiceCosts")
                        .HasForeignKey("CustomerInvoiceCostID")
                    ...
                    b.Navigation("CustomerInvoiceCost");
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.CustomerInvoice", b =>
                {
                    b.Navigation("CustomerInvoiceAmountPaid");
