...
namespace API.Migrations
{
    ...
    [Migration("20250403155214_AddedRelationsWithCostsAndNewTableForCustomer")]
    partial class AddedRelationsWithCostsAndNewTableForCustomer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.CustomerInvoiceAmoutPaid", b =>
                {
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TokenID = 1,
                            Created = new DateTime(2025, 4, 3, 17, 52, 12, 143, DateTimeKind.Local).AddTicks(2224),
                            Expires = new DateTime(2025, 4, 13, 17, 52, 12, 143, DateTimeKind.Local).AddTicks(2282),
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.CustomerInvoiceAmoutPaid", b =>
                {
                    b.HasOne("Entity_Validator.Entity.Entities.CustomerInvoice", "CustomerInvoice")
                        .WithOne("CustomerInvoiceAmoutPaid")
                        .HasForeignKey("Entity_Validator.Entity.Entities.CustomerInvoiceAmoutPaid", "CustomerInvoiceID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
            ...
            modelBuilder.Entity("Entity_Validator.Entity.Entities.CustomerInvoice", b =>
                {
                    b.Navigation("CustomerInvoiceAmoutPaid");
